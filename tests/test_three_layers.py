...
class TestThreeLayersMenu(unittest.TestCase):
    ...
    @patch('basic_interactive_menu.interactive_menu.input', side_effect=['0', 'r', '1', 'r', '2', '0', '1, 2 3', 'y'])
    ...
    @patch('basic_interactive_menu.interactive_menu.input', side_effect=['0', '0', 'r', 'r', '1', '1', '0', 'y'])
    ...
    @patch('basic_interactive_menu.interactive_menu.input', side_effect=['0', '0', 'r', '1', '1', 'r', '2', '2', '1, 2', 'y'])
    def test_selection_persistence_and_return(self, mock_input):
        main()
        output = self.held_output.getvalue()
        self.assertIn("You selected: data3.txt", output)

    @patch('basic_interactive_menu.interactive_menu.input', side_effect=['0', '0', '1, 2  3', 'l', 'r', 'r', 'q'])
    def test_escape_all_levels(self, mock_input):
        main()
        output = self.held_output.getvalue()
        self.assertIn("Exiting...", output)

    @patch('basic_interactive_menu.interactive_menu.input', side_effect=['0', '0', 'r', 'r', 'r', 'r', 'q'])
    ...
    @patch('basic_interactive_menu.interactive_menu.input', side_effect=['0', '0', '2, 3', 'r', '1', '1', '1, 3 4', 'y'])
